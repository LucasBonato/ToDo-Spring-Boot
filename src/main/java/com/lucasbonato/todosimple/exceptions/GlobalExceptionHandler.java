...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleAllUncaughtException(Exception exception, WebRequest request) {
        final String ERROR_MESSAGE = "Unknown error occurred.";
        log.error(ERROR_MESSAGE, exception);
        return buildErrorResponse(exception, ERROR_MESSAGE, HttpStatus.INTERNAL_SERVER_ERROR, request);
    }
    ...
    private ResponseEntity<Object> buildErrorResponse(Exception exception, String errorMessage, HttpStatus httpStatus, WebRequest request) {
